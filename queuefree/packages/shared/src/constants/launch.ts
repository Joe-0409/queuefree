...
export const LAUNCH_MARKET = LAUNCH_MARKET_CODE;
export const LAUNCH_CURRENCY = LAUNCH_CURRENCY_CODE;
export const LAUNCH_RULE_VERSION = RULE_VERSION;
export const LAUNCH_WEBSITE = PUBLIC_WEBSITE_DOMAIN;
