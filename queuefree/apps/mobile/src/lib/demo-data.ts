...
export const demoQueueEntries: QueueEntryCardModel[] = [
  ...
  },
  {
    ...
    status: QueueEntryStatus.FROZEN,
    currentRank: null,
    boostUsed: 0,
  ...
  },
  {
    ...
    status: QueueEntryStatus.WON_PENDING_RELEASE,
    currentRank: 1,
    boostUsed: 2,
